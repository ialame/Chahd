...
**2)** Soient les points $E(5,1,4)$ et $F(-1,1,12)$, et soit $(S)$ l'ensemble des points $M$ vérifiant $\vec{ME} \cdot \vec{MF} = 0$. \\
...
**3)** On considère le nombre complexe $h = \cos\frac{\pi}{12} + i\sin\frac{\pi}{12}$. Montrer que $h^4 + 1 = a$.
